...
struct ShoppingListView_Previews: PreviewProvider {
    static var previews: some View {
        ShoppingListView(selectedRecipe: [Recipe(id: 3,
                                 name: "Margherita Pizza",
                                 ingredients: [
                                    Ingredient(quantity: 1, unitType: UnitType.Pcs, name: "Tomato"),
                                    Ingredient(quantity: 1, unitType: UnitType.Pcs, name: "Pizza Base"),
                                    Ingredient(quantity: 100, unitType: UnitType.g, name: "Cheese"),
                                 ],
                                 totalTime: 10, instructions: ["1.", "2.", "3."],
                                 servings: 4,
                                 cardColor: "Color4"
                          ...
                          Recipe(id: 2, name: "Shepherds Pie",
                                 ingredients: [
                                    Ingredient(quantity: 1, unitType: UnitType.Pcs, name: "Potato"),
                                    Ingredient(quantity: 40.56, unitType: UnitType.Kg, name: "Cherry Tomatoes"),
                                 ],
                                 totalTime: 10, instructions: ["1.", "2.", "3."],
                                 servings: 4,
                                 cardColor: "Color3"
                          ...
                          Recipe(id: 1,
                                 name: "Cheese Sandwich",
                                 ingredients: [
                                    Ingredient(quantity: 2, unitType: UnitType.Pcs, name: "Slice of Bread"),
                                    Ingredient(quantity: 100, unitType: UnitType.g, name: "Cheese"),
                                ],
                                 totalTime: 10, instructions: ["1.", "2.", "3."],
                                 servings: 4,
